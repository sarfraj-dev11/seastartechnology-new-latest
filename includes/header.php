...
<html lang="en">
<head>
<!-- Google tag (gtag.js) --> <script async src="https://www.googletagmanager.com/gtag/js?id=G-ZE4WNLT14F"></script> <script>   window.dataLayer = window.dataLayer || [];   function gtag(){dataLayer.push(arguments);}   gtag('js', new Date());   gtag('config', 'G-ZE4WNLT14F'); </script>
...
<div class="top-bar">
  <div class="container top-bar-inner">
    ...
    <a href="mailto:<?php echo SITE_SALES_EMAIL; ?>" class="top-bar-email">
  <i class="fas fa-envelope"></i> 
  Sales:
  <?php echo SITE_SALES_EMAIL; ?>
</a>
  </div>
</div>
